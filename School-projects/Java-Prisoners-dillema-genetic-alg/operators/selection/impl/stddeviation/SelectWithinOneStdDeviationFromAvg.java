...
public class SelectWithinOneStdDeviationFromAvg implements SelectionOperator {
    ...
    public Population selectFromPopulation(Population toSelectFrom) {
        ...
        for(Strategy singleStrat : toSelectFrom.prisonerStrategies) {
            if((singleStrat.avgPoints >= toSelectFrom.avgPoints - toSelectFrom.stdDeviation) && (singleStrat.avgPoints <= toSelectFrom.avgPoints + toSelectFrom.stdDeviation)) {
